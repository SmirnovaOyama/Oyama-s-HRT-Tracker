...
export const TRANSLATIONS_BASE = {
    zh: {
        ...
        "field.gel_site": "涂抹位置",
        "dose.guide.title": "剂量级别提示",
        "dose.guide.current": "当前输入",
        "dose.guide.current_blank": "当前未输入剂量",
        "dose.guide.reference": "参考范围",
        "dose.guide.patch_rate_hint": "贴片提示基于释放速率，请切换到“释放速率”输入查看。",
    ...
    en: {
        ...
        "qr.too_large": "Data is too large to render as QR.",
        ...
        "dose.guide.patch_rate_hint": "Switch to release-rate input to view patch guidance.",
    ...
    ru: {
        ...
        "qr.too_large": "Данные слишком большие для QR. Используйте экспорт JSON.",
        ...
        "dose.guide.current": "Текущий ввод",
        "dose.guide.current_blank": "Введите дозу, чтобы увидеть подсказку",
        "dose.guide.reference": "Справочные диапазоны",
        "dose.guide.patch_rate_hint": "Подсказка для пластыря основана на скорости высвобождения; переключитесь на ввод скорости.",
...
export const TRANSLATIONS = {
    ...
    yue: {
        ...
        "dose.guide.current": "目前輸入",
        "dose.guide.current_blank": "輸入劑量後會顯示提示",
        "dose.guide.reference": "參考範圍",
        "dose.guide.patch_rate_hint": "貼片提示基於釋放速率，請切到「釋放速率」輸入。",
        "dose.guide.level.low": "低劑量",
        "dose.guide.level.medium": "中等劑量",
        "dose.guide.level.high": "高劑量",
        "dose.guide.level.very_high": "超高劑量",
